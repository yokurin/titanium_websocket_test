...
//@interface tiSocket_ioObject : NSObject
//@end

@interface tiSocket_ioObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[tiSocket_ioObject class]])
		{
			for (NSString *key in [[(tiSocket_ioObject*)o modules] allKeys])
			{
