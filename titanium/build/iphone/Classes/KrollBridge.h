...
@interface tiSocket_ioObject : KrollCoverageObject {
#else
@interface tiSocket_ioObject : KrollObject {
#endif
@private
...
extern NSString * tiSocket_io$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	tiSocket_ioObject *_tisocket_io;
    KrollObject* console;
	BOOL shutdown;
