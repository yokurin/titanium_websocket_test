...
/**
 Base class for all tiSocket_io views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the tiSocket_io view hierarchy (such as wrapped iOS UIViews) was touched.
