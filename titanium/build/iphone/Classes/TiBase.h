...
// in simulator we redefine to format for tiSocket_io Developer console
...
{\
	NSString * exceptionName = [@"org.tisocket_io." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tisocket_io";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UItiSocket_ioNativeItemNone = -1, 
	UItiSocket_ioNativeItemSpinner = -2,
	UItiSocket_ioNativeItemProgressBar = -3,
	
	UItiSocket_ioNativeItemSlider = -4,
	UItiSocket_ioNativeItemSwitch = -5,
	UItiSocket_ioNativeItemMultiButton = -6,
	UItiSocket_ioNativeItemSegmented = -7,
	
	UItiSocket_ioNativeItemTextView = -8,
	UItiSocket_ioNativeItemTextField = -9,
	UItiSocket_ioNativeItemSearchBar = -10,
	
	UItiSocket_ioNativeItemPicker = -11,
	UItiSocket_ioNativeItemDatePicker = -12,
	
	UItiSocket_ioNativeItemInfoLight = -13,
	UItiSocket_ioNativeItemInfoDark = -14,
	
	UItiSocket_ioNativeItemDisclosure = -15,
	
	UItiSocket_ioNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all tiSocket_io instances of
