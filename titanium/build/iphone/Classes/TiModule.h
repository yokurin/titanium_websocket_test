...
/**
 The base class for all tiSocket_io modules
 */
...
/**
 tiSocket_io Platform calls this method on startup.
 */
-(void)startup;

/**
 tiSocket_io Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 tiSocket_io Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 tiSocket_io Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 tiSocket_io Platform calls this method on resume.
 @param sender The sender of the event.
 */
